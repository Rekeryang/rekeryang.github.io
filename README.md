...
### [我的博客在这里 &rarr;](http://rekeryang.com)
...
我的博客仓库——`rekeryang.github.io`，是经常修改的，而且还会有人乱提交代码，因此给大家做了一个稳定版的模板。大家可以直接fork模板——`jekyll-bootstrap-theme`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。

```
$ git clone 
```

**[在这里预览模板 &rarr;](http://rekeryang.com/jekyll-bootstrap-theme/)**
...
看右边:
![](http://rekeryang.com/img/blog-sidebar.jpg)
...
![](http://rekeryang.com/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://rekeryang.com/js-module-7day/"
---
```
...
ga_domain: rekeryang.com			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
