...
### [View Rekeryang  Blog &rarr;](https://rekeryang.com/jekll-bootstrap-theme)

![](https://rekeryang.com/jekyll-bootstrap-theme/img/blog-desktop.png)
...
```
$ git clone https://github.com/Rekeryang/jekyll-bootstrap-theme.git
```
...
## Translation
 ...
 - ![cn](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/China.png) **Chinese (Simplified)**: 的 [中文翻译 &rarr;](https://github.com/Rekeryang/jekyll-bootstrap-theme/blob/master/README.zh.md)
...
It's possible that you want the two things different. For me, my site-title is **“Rekeryang Blog”** but I want the title shows in search engine is **“睿客杨的博客 | Rekeryang Blog”** which is multi-language.
...
Apache License 2.0.
Copyright (c) 2017-2019 Rekeryun

Rekeryang  Blog is derived from [Clean Blog Jekyll Theme (MIT License)](https://github.com/BlackrockDigital/startbootstrap-clean-blog-jekyll/)
Copyright (c) 2017-2019 Blackrock Digital LLC.clean-blog-jekyll/)
ean-blog-jekyll/)
Copyright (c) 2013-2016 Blackrock Digital LLC.Copyright (c) 2017-2019 Blackrock Digital LLC.clean-blog-jekyll/)
ean-blog-jekyll/)
